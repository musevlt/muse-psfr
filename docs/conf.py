...
latex_documents = [
    (master_doc, 'PSFRec.tex', 'PSFRec Documentation',
     'Simon Conseil, Thierry Fusco', 'manual'),
]
...
man_pages = [
    (master_doc, 'psfrec', 'PSFRec Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PSFRec', 'PSFRec Documentation',
     author, 'PSFRec', 'One line description of project.',
     'Miscellaneous'),
]
